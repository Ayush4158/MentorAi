          ...
          <DropdownMenuContent>
            <DropdownMenuItem>
              <Link  href={'/resume'} className='flex items-center gap-2'>
                <FileText className='h-4 w-4'><span>Build Resume</span></FileText>
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link  href={'/ai-cover-letter'} className='flex items-center gap-2'>
                <PenBox className='h-4 w-4'><span>Cover Letter</span></PenBox>
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link  href={'/interview'} className='flex items-center gap-2'>
                <GraduationCap className='h-4 w-4'><span>Interview Prep</span></GraduationCap>
              </Link>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
